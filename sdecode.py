...
class Toplevel1:
    def funsdecode(self):
        ...
        bytename=int(self.bytetext.get("1.0",'end-1c'));
        recover_data(sname,oname,bytename)
    ...
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=self.funsdecode)
...
def recover_data(sound_path,output_path,bytes_to_recover):
    #sound_path =input("SOUND FILE (with extension):")
    #output_path =input("OUTPUT FILE (with extension):")
    #bytes_to_recover = int(input("BYTES TO RETRIEVE :"))
